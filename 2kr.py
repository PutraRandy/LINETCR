...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EnlRYqL4DlWKIr9dfIU2.WUI0jVzzeewupQ5tboz8mG.K5G366kQX+YWWdGRGXAwMU2rHcF2hhu0Lm3JmSNUPKI=")#1beby
cl.loginResult()

satpam = LINETCR.LINE()
satpam.login(token="EnrNejwvrgZlyCoYjSdc.SJRuNecAXNC8sHurfor2ha.jD7wclOBbItb9PXfzVA4BhBq5AkfkfdpkQBVbAigijw=")#satpam opo
...
║╚════════════
║   TANKS FOR YOU TCR AND MY FRIENDS
╚═════════════
"""
...
admin=["uc2e8b426f6591045943eae5304e67c32","ub23ad49c409ac6773c4a151114e4761c",mid,Amid,Bmid,Cmid]
creator=["uc2e8b426f6591045943eae5304e67c32","ub23ad49c409ac6773c4a151114e4761c",mid,Amid,Bmid,Cmid]
owner=["uc2e8b426f6591045943eae5304e67c32","ub23ad49c409ac6773c4a151114e4761c",mid,Amid,Bmid,Cmid]
wait = {
    'contact':False,
    'autoJoin':True,
